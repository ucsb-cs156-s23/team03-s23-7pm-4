...
describe("UserTable tests", () => {
  ...
  test("Has the expected colum headers and content for adminUser", () => {
    ...
    const expectedHeaders = ["id", "Name", "Description", "Price"];
    const expectedFields = ["id", "name", "description", "price"];
  ...
  test("Edit button navigates to the edit page for admin user", async () => {
    ...
    await waitFor(() => { expect(getByTestId(`RestaurantTable-cell-row-0-col-id`)).toHaveTextContent("1"); });
